...
exports.JobsServices = {
    getAllJobs: (req) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    getJobById: (req) => __awaiter(void 0, void 0, void 0, function* () {
        const { id } = req.params;
        return yield jobsRepo_1.jobsRepo.find({
            where: {
                id
    ...
    createJob: (req) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    updateJob: (req) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    deleteJob: (req) => __awaiter(void 0, void 0, void 0, function* () {
        return yield jobsRepo_1.jobsRepo.delete(req.jobFound.id);
    })
};
